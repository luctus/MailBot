...
abstract class BaseLog extends BaseObject  implements Persistent
{
  ...
  const PEER = 'LogPeer';
	...
	/**
	 * The value for the cuenta_id field.
	 * @var        int
	 */
	protected $cuenta_id;

	/**
	 * The value for the what field.
	 * @var        string
	 */
	protected $what;
	...
	/**
	 * Get the [cuenta_id] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [cuenta_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Log The current object (for fluent API support)
	 */
	public function setCuentaId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}
		...
		if ($this->cuenta_id !== $v) {
			$this->cuenta_id = $v;
			$this->modifiedColumns[] = LogPeer::CUENTA_ID;
		}
	...
	public function setWhat($v)
	{
		...
		if ($this->what !== $v) {
			$this->what = $v;
			$this->modifiedColumns[] = LogPeer::WHAT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cuenta_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->what = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			...
			return $startcol + 4; // 4 = LogPeer::NUM_COLUMNS - LogPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aCuenta !== null && $this->cuenta_id !== $this->aCuenta->getId()) {
			$this->aCuenta = null;
		}
	} // ensureConsistency
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getCuentaId(),
			$keys[2] => $this->getWhat(),
			$keys[3] => $this->getCreatedAt(),
		);
		if ($includeForeignObjects) {
			if (null !== $this->aCuenta) {
				$result['Cuenta'] = $this->aCuenta->toArray($keyType, $includeLazyLoadColumns, true);
			}
		}
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setCuentaId($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LogPeer::CUENTA_ID)) $criteria->add(LogPeer::CUENTA_ID, $this->cuenta_id);
		if ($this->isColumnModified(LogPeer::WHAT)) $criteria->add(LogPeer::WHAT, $this->what);
	...
	{
		$copyObj->setCuentaId($this->cuenta_id);
	...
	{
		if ($v === null) {
			$this->setCuentaId(NULL);
		} else {
			$this->setCuentaId($v->getId());
		}
	...
	{
		if ($this->aCuenta === null && ($this->cuenta_id !== null)) {
			$this->aCuenta = CuentaQuery::create()->findPk($this->cuenta_id, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCuenta->addLogs($this);
			 */
		}
		return $this->aCuenta;
	}
