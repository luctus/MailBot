...
abstract class BaseCuentaPeer {
	...
	const USERNAME = 'cuenta.USERNAME';

	/** the column name for the CREDENTIAL field */
	const CREDENTIAL = 'cuenta.CREDENTIAL';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Credential', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'credential', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::CREDENTIAL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'CREDENTIAL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'credential', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Credential' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'credential' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::CREDENTIAL => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'CREDENTIAL' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'credential' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(CuentaPeer::USERNAME);
			$criteria->addSelectColumn(CuentaPeer::CREDENTIAL);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.USERNAME');
			$criteria->addSelectColumn($alias . '.CREDENTIAL');
		}
	}
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = CuentaPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + CuentaPeer::NUM_COLUMNS;
		} else {
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += CuentaPeer::doOnDeleteCascade(new Criteria(CuentaPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += CuentaPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = CuentaPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(LogPeer::CUENTA_ID, $obj->getId());
