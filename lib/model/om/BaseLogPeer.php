...
abstract class BaseLogPeer {
	...
	/** the column name for the CUENTA_ID field */
	const CUENTA_ID = 'log.CUENTA_ID';

	/** the column name for the WHAT field */
	const WHAT = 'log.WHAT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CuentaId', 'What', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'cuentaId', 'what', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CUENTA_ID, self::WHAT, self::CREATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CUENTA_ID', 'WHAT', 'CREATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'cuenta_id', 'what', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CuentaId' => 1, 'What' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'cuentaId' => 1, 'what' => 2, 'createdAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CUENTA_ID => 1, self::WHAT => 2, self::CREATED_AT => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CUENTA_ID' => 1, 'WHAT' => 2, 'CREATED_AT' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'cuenta_id' => 1, 'what' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(LogPeer::CUENTA_ID);
			$criteria->addSelectColumn(LogPeer::WHAT);
			$criteria->addSelectColumn(LogPeer::CREATED_AT);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.CUENTA_ID');
			$criteria->addSelectColumn($alias . '.WHAT');
	...
	public static function doCountJoinCuenta(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(LogPeer::CUENTA_ID, CuentaPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Log objects pre-filled with their Cuenta objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinCuenta(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to $obj2 (Cuenta)
				$obj2->addLog($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		CuentaPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + (CuentaPeer::NUM_COLUMNS - CuentaPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to the collection in $obj2 (Cuenta)
				$obj2->addLog($obj1);
