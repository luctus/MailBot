...
/**
 * MbMail form base class.
 *
 * @method MbMail getObject() Returns the current form's model object
 *
 * @package    mailbot
 * @subpackage form
 * @author     Gustavo Garcia - UDT
 */
abstract class BaseMbMailForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      'id'          => new sfValidatorPropelChoice(array('model' => 'MbMail', 'column' => 'id', 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('mb_mail[%s]');
