 ...
 *
 * @method     sfGuardRememberKeyQuery leftJoinsfGuardUser($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardUser relation
 * @method     sfGuardRememberKeyQuery rightJoinsfGuardUser($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardUser relation
 * @method     sfGuardRememberKeyQuery innerJoinsfGuardUser($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardUser relation
 *
