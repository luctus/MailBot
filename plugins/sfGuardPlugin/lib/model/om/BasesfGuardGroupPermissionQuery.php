 ...
 *
 * @method     sfGuardGroupPermissionQuery leftJoinsfGuardGroup($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardGroup relation
 * @method     sfGuardGroupPermissionQuery rightJoinsfGuardGroup($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardGroup relation
 * @method     sfGuardGroupPermissionQuery innerJoinsfGuardGroup($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardGroup relation
 *
 * @method     sfGuardGroupPermissionQuery leftJoinsfGuardPermission($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardPermission relation
 * @method     sfGuardGroupPermissionQuery rightJoinsfGuardPermission($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardPermission relation
 * @method     sfGuardGroupPermissionQuery innerJoinsfGuardPermission($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardPermission relation
 *
...
abstract class BasesfGuardGroupPermissionQuery extends ModelCriteria
{
	 ...
	 * @return    sfGuardGroupPermissionQuery The current query, for fluid interface
	 */
	public function joinsfGuardGroup($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
	 ...
	 * @return    sfGuardGroupPermissionQuery The current query, for fluid interface
	 */
	public function joinsfGuardPermission($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
		$tableMap = $this->getTableMap();
