 ...
 *
 * @method     sfGuardUserGroupQuery leftJoinsfGuardUser($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardUser relation
 * @method     sfGuardUserGroupQuery rightJoinsfGuardUser($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardUser relation
 * @method     sfGuardUserGroupQuery innerJoinsfGuardUser($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardUser relation
 *
 * @method     sfGuardUserGroupQuery leftJoinsfGuardGroup($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardGroup relation
 * @method     sfGuardUserGroupQuery rightJoinsfGuardGroup($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardGroup relation
 * @method     sfGuardUserGroupQuery innerJoinsfGuardGroup($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardGroup relation
 *
