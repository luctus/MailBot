 ...
 *
 * @method     sfGuardPermissionQuery leftJoinsfGuardGroupPermission($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardGroupPermission relation
 * @method     sfGuardPermissionQuery rightJoinsfGuardGroupPermission($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardGroupPermission relation
 * @method     sfGuardPermissionQuery innerJoinsfGuardGroupPermission($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardGroupPermission relation
 *
 * @method     sfGuardPermissionQuery leftJoinsfGuardUserPermission($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardUserPermission relation
 * @method     sfGuardPermissionQuery rightJoinsfGuardUserPermission($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardUserPermission relation
 * @method     sfGuardPermissionQuery innerJoinsfGuardUserPermission($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardUserPermission relation
 *
...
abstract class BasesfGuardPermissionQuery extends ModelCriteria
{
	 ...
	 * @return    sfGuardPermissionQuery The current query, for fluid interface
	 */
	public function joinsfGuardGroupPermission($relationAlias = '', $joinType = Criteria::INNER_JOIN)
	{
