 ...
 *
 * @method     sfGuardUserPermissionQuery leftJoinsfGuardUser($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardUser relation
 * @method     sfGuardUserPermissionQuery rightJoinsfGuardUser($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardUser relation
 * @method     sfGuardUserPermissionQuery innerJoinsfGuardUser($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardUser relation
 *
 * @method     sfGuardUserPermissionQuery leftJoinsfGuardPermission($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardPermission relation
 * @method     sfGuardUserPermissionQuery rightJoinsfGuardPermission($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardPermission relation
 * @method     sfGuardUserPermissionQuery innerJoinsfGuardPermission($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardPermission relation
 *
