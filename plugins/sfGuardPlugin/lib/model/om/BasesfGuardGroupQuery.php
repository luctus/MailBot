 ...
 *
 * @method     sfGuardGroupQuery leftJoinsfGuardGroupPermission($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardGroupPermission relation
 * @method     sfGuardGroupQuery rightJoinsfGuardGroupPermission($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardGroupPermission relation
 * @method     sfGuardGroupQuery innerJoinsfGuardGroupPermission($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardGroupPermission relation
 *
 * @method     sfGuardGroupQuery leftJoinsfGuardUserGroup($relationAlias = '') Adds a LEFT JOIN clause to the query using the sfGuardUserGroup relation
 * @method     sfGuardGroupQuery rightJoinsfGuardUserGroup($relationAlias = '') Adds a RIGHT JOIN clause to the query using the sfGuardUserGroup relation
 * @method     sfGuardGroupQuery innerJoinsfGuardUserGroup($relationAlias = '') Adds a INNER JOIN clause to the query using the sfGuardUserGroup relation
 *
